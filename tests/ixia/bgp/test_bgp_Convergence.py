...
from helper import run_bgp_convergence_test
from tests.common.fixtures.conn_graph_facts import (conn_graph_facts, fanout_graph_facts)
import pytest

def test_bgp_convergence(snappi_api,duthost,tgen_ports,conn_graph_facts,fanout_graph_facts):
    ...
    """
    run_bgp_convergence_test(snappi_api,duthost,tgen_ports)